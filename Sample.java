...
class Sample {
    ...
    public static void main(String[] args) {
        ...
        while ((ready_queue.size()) != 0) {
            ...
            //one more condition to be added to make sure its not PC
            try {
            ...
            // remove the executing processess from the ready queue
    ...
    static void print_gantt_chart() {
        ...
        for (int i = 0; i < gantt_chart.size() - 1; i++) {
            ...
            if (i < gantt_chart.size() - 1 && gantt_chart.get(i) == gantt_chart.get(i + 1)) {
                ...
                masterCount += count + 1;
                ganttChartOutput += "P" + gantt_chart.get(i) + "__" + masterCount + "__";
                count = 0;
            }
            whichProcess = gantt_chart.get(i);
        }
        masterCount += count + 1;
        ganttChartOutput += "P" + whichProcess + "__" + masterCount;
